...
.bodysection {
    ...
    .herosection {
        ...
        .herosliders {
            ...
            // border: solid;
            margin-top: 4rem;
            // box-shadow: inset 2rem 0px 0px 0px rgba(255, 255, 255, 0.993),
            //             inset  -2rem 0px 0px 0px rgba(255, 255, 255, 0.333);
    ...
    .section2 {
        ...
        background-color: rgba(130, 98, 29, 0.299);
        height: 40rem;
        display: flex;
        flex-direction: column;
        gap: 4rem;
